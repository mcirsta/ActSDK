...
cp -f config_spi_nor_qvga_style_2.txt config.txt
...
if "%callfrom%"=="" (
    rem 双击运行
    ..\..\..\tools\fw_maker\FIMaker.exe fwimage_spi_nor_qvga_style_2.cfg
...
if "%msgfile%"=="" (
    ..\..\..\tools\fw_maker\Maker.exe -c fwimage_spi_nor_qvga_style_2.cfg -o %firmware%
    set retval=1
    goto make_finish
)
..\..\..\tools\fw_maker\Maker.exe -c fwimage_spi_nor_qvga_style_2.cfg -o %firmware% >%msgfile% 2>&1
set retval=1
:make_finish
