...
*                        All Right Reserved 
*
* FileName: em_second_level_menu.h     Author:  张三        Date:2008/04/27
* Description:   em_second_level_menu.c中的全局函数，应用中其他的C文件用到的 
* Others:         
* History:        
...
#ifndef      __EM_SECOND_LEVEL_MENU_H__
#define      __EM_SECOND_LEVEL_MENU_H__
