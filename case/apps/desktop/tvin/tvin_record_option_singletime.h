 ...
 *                            All Rights Reserved. 
 * file : tvin_record_option_singletime.h
 * History:         
...
/*!
 * \file       tvin_record_option_singletime.h
 * \brief     define  data structure single record time
 * \author   Jerry Fu 
 *               
 * \version 1.0
 * \date  2009/04/28
...
#ifndef   __TVIN_OPTION_SINGLETIME_H__
#define   __TVIN_OPTION_SINGLETIME_H__
