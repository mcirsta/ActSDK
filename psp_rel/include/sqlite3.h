 ...
 **
 ** @(#) $Id: sqlite3.h,v 1.1.4.3 2008/11/20 10:12:18 wurui Exp $
 */
#ifndef _SQLITE3_H_
#define _SQLITE3_H_

#include "stdarg.h"     /* Needed for the definition of va_list */
#include "sqlite_configure.h"
#include "assert.h"
...
typedef unsigned int sqlite_uint64;
#endif
...
struct sqlite3_io_methods
{
    ...
    int (*xRead)(sqlite3_file*, void*, int iAmt, int iOfst);
    int (*xWrite)(sqlite3_file*, const void*, int iAmt, int iOfst);
    int (*xTruncate)(sqlite3_file*, int size);
    int (*xSync)(sqlite3_file*, int flags);
    int (*xFileSize)(sqlite3_file*, int *pSize);
...
int sqlite3_create_function(sqlite3 *db, const char *zFunctionName, int nArg,
        int eTextRep, void *pApp, void(*xFunc)(sqlite3_context*, int,
                sqlite3_value**), void(*xStep)(sqlite3_context*, int,
...
int sqlite3_memory_alarm(void(*)(void*, int, int), void*, int);
...
void
        sqlite3_result_text16le(sqlite3_context*, const void*, int, void(*)(
                void*));
void
        sqlite3_result_text16be(sqlite3_context*, const void*, int, void(*)(
                void*));
 ...
 */
int sqlite3_create_collation(sqlite3*, const char *zName, int eTextRep, void*,
...
int sqlite3_create_collation_v2(sqlite3*, const char *zName, int eTextRep,
        ...
        void(*xDestroy)(void*));
int sqlite3_create_collation16(sqlite3*, const char *zName, int eTextRep,
        void*, int(*xCompare)(void*, int, const void*, int, const void*));
 ...
 ** of SQLite.
 */
int sqlite3_key(sqlite3 *db, /* Database to be rekeyed */
 ...
 ** of SQLite.
 */
int sqlite3_rekey(sqlite3 *db, /* Database to be rekeyed */
...
int sqlite3SetTmpDirectory(char *temp_directory);
 ...
 */
int sqlite3_create_module_v2(sqlite3 *db, /* SQLite connection to register module with */
const char *zName, /* Name of the module */
const sqlite3_module *, /* Methods for the module */
void *, /* Client data for xCreate/xConnect */
...
void sqlite3_setExternAlloc(alloc_ext_t *alloc_user);
void sqlite3_resetAlloc();
int debug_heap_used();
