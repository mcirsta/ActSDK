...
typedef struct CU_Test
{
    ...
    CU_InitializeFunc pInitializeFunc; /**< Pointer to the test initialization function. */
    CU_CleanupFunc pCleanupFunc; /**< Pointer to the test cleanup function. */
...
typedef struct CU_TestRegistry
{
    ...
    CU_InitializeFunc pInitializeFunc; /**< Pointer to the registry initialization function. */
    CU_CleanupFunc pCleanupFunc; /**< Pointer to the registry cleanup function. */
    const char *pName; /**< Registry name. */
} CU_TestRegistry;
typedef CU_TestRegistry* CU_pTestRegistry; /**< Pointer to a CUnit test registry. */

/* Public interface functions */
CU_EXPORT CU_ErrorCode CU_initialize_registry(CU_InitializeFunc pInit, CU_CleanupFunc pClean);
CU_EXPORT void CU_registry_setname(const char *name);
...
typedef struct CU_TestInfo
{
    ...
    CU_InitializeFunc pInitFunc; /**< Test initialization function. */
    CU_CleanupFunc pCleanupFunc; /**< Test cleanup function */
} CU_TestInfo;
...
#define CU_TEST_INFO_NULL  { NULL, NULL, NULL, NULL }
...
CU_EXPORT CU_pTestRegistry CU_create_new_registry(CU_InitializeFunc pInit, CU_CleanupFunc pClean);
...
CU_pTest create_test(const char* strName, CU_TestFunc pTestFunc, CU_InitializeFunc pInit, CU_CleanupFunc pClean);
void cleanup_test(CU_pTest pTest);
void insert_test(CU_pSuite pSuite, CU_pTest pTest);
CU_BOOL suite_exists(CU_pTestRegistry pRegistry, const char* szSuiteName);
CU_BOOL test_exists(CU_pSuite pSuite, const char* szTestName);
