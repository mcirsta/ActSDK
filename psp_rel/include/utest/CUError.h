...
typedef enum
{
    ...
    CUE_SEGFAULT = 2, /**< Segmentation violation */
    ...
    CUE_RINIT_FAILED = 25, /**< Registry initialization failed. */
    CUE_RCLEAN_FAILED = 26, /**< Registry cleanup failed. */
    CUE_TINIT_FAILED = 27, /**< Test initialization failed. */
    CUE_TCLEAN_FAILED = 28, /**< Test cleanup failed. */
...
CU_EXPORT const char* get_error_desc(CU_ErrorCode iError);
