/*====================================================================
 ...
 All Right Reserved
 Filename   : Actions_reg_GL3996.h
 Version    : 1.1
 Author     : zhaohongtao      zhaohongtao@actions-semi.com
 Data       : 2009-1-7 10:29:39
 Description: Define 215x's registers
 According to GL3996_Spec_1_03_20080417.doc
 Revision History:
 2009-1-7 10:29:43  establish 1.0 version
 2009-6-22 13:56:58 modify PCNT module base address
 ......
 =====================================================================*/
#ifndef  __ACTIONS_REG_GL3996_H__
#define  __ACTIONS_REG_GL3996_H__
//--------PMU/LRADC--------------------------------------------------
...
#define  NAND_CLKCTL                 (0xB00A0000 + 0x00000008)
#define  NAND_SPARE_COLADDR          (0xB00A0000 + 0x0000000C)
#define  NAND_MAIN_COLADDR           (0xB00A0000 + 0x00000010)
#define  NAND_ROWADDRLO              (0xB00A0000 + 0x00000014)
#define  NAND_ROWADDRHI              (0xB00A0000 + 0x00000018)
#define  NAND_BC                     (0xB00A0000 + 0x0000001C)
#define  NAND_UDATA                  (0xB00A0000 + 0x00000020)

#define  NAND_CMD_FSM                (0xB00A0000 + 0x00000024)
#define  NAND_DATA                   (0xB00A0000 + 0x00000028)
#define  NAND_ECCCTL                 (0xB00A0000 + 0x0000002C)
#define  NAND_ECCEX0                 (0xB00A0000 + 0x00000030)
#define  NAND_ECCEX1                 (0xB00A0000 + 0x00000034)
#define  NAND_ECCEX2                 (0xB00A0000 + 0x00000038)
#define  NAND_ECCEX3                 (0xB00A0000 + 0x0000003C)
#define  NAND_ECCEX4                 (0xB00A0000 + 0x00000040)
#define  NAND_ECCEX5                 (0xB00A0000 + 0x00000044)
#define  NAND_ECCEX6                 (0xB00A0000 + 0x00000048)
#define  NAND_ECCEX7                 (0xB00A0000 + 0x0000004C)
//--------SD I/F-----------------------------------------------------
...
#define  MHA_DCSCL                   (0xB00C0000 + 0x00000010)
#define  MHA_DIVDCSCL                (0xB00C0000 + 0x00000014)
#define  MHA_QSCL                    (0xB00C0000 + 0x00000018)
#define  MHA_DIVQSCL                 (0xB00C0000 + 0x0000001C)
//--------ITU656 PORT------------------------------------------------
//General Register for output parts & internal TV-Encoder
...
//General Register for input parts & external TV-Decoder, External CMOS Sensor, TS
...
//--------SPI--------------------------------------------------------
#define  SPI_CTL                     0xB0080000 + 0x00000000
#define  SPI_CLKDIV                  0xB0080000 + 0x00000004
#define  SPI_STAT                    0xB0080000 + 0x00000008
#define  SPI_RXDAT                   0xB0080000 + 0x0000000C
#define  SPI_TXDAT                   0xB0080000 + 0x00000010
//--------KEY SCAN------------------------------------------
...
#endif /*__ACTIONS_REG_GL3996_H__*/
