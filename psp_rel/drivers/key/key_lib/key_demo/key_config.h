...
#define ADC_KEY_ENABLE          0   /*adc按键,     1:有,0:无;  配置项2*/

#define SINGLE_GPIO_KEY_ENABLE  0   /*单GPIO按键,  1:有,0:无;  配置项3*/

#define GPIO_MATRIX_KEY_ENABLE  0   /*GPIO矩阵按键,1:有,0:无;  配置项4*/

#define SCAN_MATIRX_KEY_ENABLE  1   /*矩阵扫描按键 1:有,0:无;  配置项5*/
...
*   
*/
#define ADC_KEY0    {0, 1, KEY_LOCK}
#define ADC_KEY1    {2, 3, KEY_NEXT}
#define ADC_KEY2    {4, 6, KEY_OK}
#define ADC_KEY3    {7, 10, KEY_RETURN}
#define ADC_KEY4    {11, 15,KEY_MENU}
#define ADC_KEY5    {-1, -1, KEY_NULL} //无效映射
/*!
*\brief
     没有按下ADC按键时的ADC值*/
#define ADC_NULL_VAL    (0x0F)
...
*   
*/
#define SINGLE_GPIO_KEY0    {GPIO_GROUP_A, 8, 0,KEY_TVOUT}
#define SINGLE_GPIO_KEY1    {GPIO_GROUP_A, 9, 0,KEY_PREV}
#define SINGLE_GPIO_KEY2    {GPIO_GROUP_A, 10,0,KEY_CAMERA}
...
*   
*/
#define GPIO_MATRIX_KEY0    { GPIO_GROUP_A, 8, 0,GPIO_GROUP_A, 9, 0,KEY_MENU}
#define GPIO_MATRIX_KEY1    { GPIO_GROUP_A, 8, 0,GPIO_GROUP_A, 10, 0,KEY_VADD}
#define GPIO_MATRIX_KEY2    { GPIO_GROUP_A, 9, 0,GPIO_GROUP_A, 10, 0,KEY_VSUB}
