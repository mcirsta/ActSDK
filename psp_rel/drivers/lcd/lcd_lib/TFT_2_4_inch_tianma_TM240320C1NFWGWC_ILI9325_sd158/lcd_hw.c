...
void  lcd_hw_init( void)
{
    ...
    _write_lcd_reg(0x0010,  0x0000);       
    _write_lcd_reg(0x0011,  0x0227);      
    _write_lcd_reg(0x0012,  0x0000);       
    _write_lcd_reg(0x0013,  0x0000);
    
    lcd_mdelay(30);  
     
    _write_lcd_reg(0x0010,  0x1690);    // Dis-charge capacitor power voltage    
    _write_lcd_reg(0x0011,  0x0227); 
    ...
    _write_lcd_reg(0x0029,  0x0029);       
    _write_lcd_reg(0x002B,  0x000D);
    ...
    _write_lcd_reg(0x0031,  0x0604);       
    _write_lcd_reg(0x0032,  0x0007);     
    _write_lcd_reg(0x0035,  0x0503); 
    _write_lcd_reg(0x0036,  0x0808);       
    _write_lcd_reg(0x0037,  0x0007);       
    _write_lcd_reg(0x0038,  0x0301);       
    _write_lcd_reg(0x0039,  0x0007); 
    _write_lcd_reg(0x003c,  0x0305); 
    _write_lcd_reg(0x003d,  0x0808);       
