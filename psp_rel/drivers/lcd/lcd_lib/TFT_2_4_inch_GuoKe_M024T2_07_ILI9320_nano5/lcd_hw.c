...
void  lcd_hw_init( void)
{
    ...
    lcd_mdelay(50);
    _write_lcd_reg(0x0010,  0x17b0);       
    _write_lcd_reg(0x0011,  0x0137); 
    lcd_mdelay(20);      
    _write_lcd_reg(0x0012,  0x013c); 
    lcd_mdelay(20);      
    _write_lcd_reg(0x0013,  0x1800);     
    _write_lcd_reg(0x0029,  0x0007); 
    lcd_mdelay(20);      
    _write_lcd_reg(0x0020,  0x0000);        					 
    _write_lcd_reg(0x0021,  0x0000);       
             
    _write_lcd_reg(0x0030,  0x0007);           
    _write_lcd_reg(0x0031,  0x0504);       
    _write_lcd_reg(0x0032,  0x0703);       
    _write_lcd_reg(0x0035,  0x0002);    
    _write_lcd_reg(0x0036,  0x0707); 
    _write_lcd_reg(0x0037,  0x0406);       
    _write_lcd_reg(0x0038,  0x0006);       
    _write_lcd_reg(0x0039,  0x0404);       
    _write_lcd_reg(0x003c,  0x0700);     
    _write_lcd_reg(0x003d,  0x0a08); 
    
    _write_lcd_reg(0x0050,  0x0000);       
    _write_lcd_reg(0x0051,  0x00ef);       
    _write_lcd_reg(0x0052,  0x0000);       
    _write_lcd_reg(0x0053,  0x013f); 
    _write_lcd_reg(0x0060,  0x2700); 
