...
//        sensor_i2c_write(0x41, 0x2b);
        sensor_i2c_write(0xc7,0x40);
        sensor_i2c_write(0xc8,0x44);
        sensor_i2c_write(0xc9,0x42);
        break;
    default:
        break;
    }
...
int sensor_set_flashlight(unsigned int arg)
{
    ...
    {        
        ...
        if (reg40 != 0)
        {
            result = (((reg04 * 256) + reg03 ) * (regdb / reg40)) * (regdc / reg40);
        }
        else
        {
            result = 0;
...
static int act_set_dc320x240_resolution(void)
{
    ...
    if (ic_type == 0x63) 
    {
        ...
        sensor_i2c_write(   0x45,  0x27); //col subsample  
