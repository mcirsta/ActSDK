...
make -f makefile_fwsp clean

if [[ $1 = "debug" ]]
then 
read -p "sdk_api"
fi
make -f makefile_fwsp sdk_api

if [[ $1 = "debug" ]]
then
read -p "boot"
fi
make -f makefile_fwsp boot

if [[ $1 = "debug" ]]
then
read -p "os"
fi
make -f makefile_fwsp os
...
make -f makefile_fwsp ko

if [[ $1 = "debug" ]]
then
read -p "pmm"
fi
make -f makefile_fwsp pmm

if [[ $1 = "debug" ]]
then
read -p "mmm"
fi
make -f makefile_fwsp mmm
